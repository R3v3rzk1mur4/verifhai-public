# Endpoints Domain: User Security Awareness with AI - Assessments
...
| L3 | 8 questions + practical | 80% + practical pass | Scenario + campaign design |

---

## Level 1 Assessment: Endpoint Security Awareness
...
**Explanation:** AI security provides fast, continuous threat detection around the clock, complementing human awareness.

---

**Q2. Which is a red flag indicating a phishing email?**

- A) Email from a known colleague about a meeting
- B) Generic greeting like "Dear Customer" with urgent request ✓
- C) Email with your name and expected content
- D) Calendar invitation you requested

**Explanation:** Generic greetings combined with urgency are classic phishing indicators.
...
**Q4. If AI security blocks an application you need for work, what should you do?**

- A) Try to disable the security software
- B) Contact IT to request an exception if it's legitimate ✓
- C) Find a way to work around the security
- D) Install the application on a personal device

**Explanation:** Contact IT for legitimate needs; they can review and create exceptions through proper channels.
...
**Explanation:** Social engineering often involves pressure to skip normal verification or procedures.

---

**Q8. When should you contact IT about a security concern?**

- A) Only after a confirmed breach
- B) When something seems suspicious, even if you're not sure ✓
- C) Never - security handles everything automatically
- D) Only if your manager tells you to

**Explanation:** Report concerns early; it's better to ask than to miss a real threat.
...
## Level 2 Assessment: Role-Based Endpoint Security
...
**Explanation:** Finance can authorize payments; HR has employee PII - both are valuable to attackers.

---

**Q2. What is Business Email Compromise (BEC)?**

- A) When email servers go down
- B) Attackers impersonate executives to trick employees into actions like wire transfers ✓
- C) When employees use personal email for work
- D) Encrypted email that can't be read

**Explanation:** BEC involves impersonating trusted people to request money transfers or sensitive data.
...
**Explanation:** Use out-of-band verification - call a known number, not one provided in the suspicious email.

---

**Scenario A:** You receive an email from your CEO asking you to urgently purchase gift cards and send the codes. The email address looks correct.

**Q4. What is the appropriate response?**

- A) Buy the gift cards immediately - it's from the CEO
- B) Verify the request by calling the CEO directly at a known number ✓
- C) Reply to ask which gift cards to buy
- D) Forward to your manager for approval

**Explanation:** This is a common BEC scam. Verify through a separate channel before taking any action.
...
**Scenario B:** A colleague asks you to help verify if an email is suspicious. They're not sure but it's asking them to update their password via a link.
...
**Explanation:** Help them analyze the email for red flags and encourage reporting to security for verification.

---

**Q8. What self-service security resources should you know about?**

- A) Only the security team knows about resources
- B) Security portal, password manager, device health check, reporting tools ✓
- C) There are no self-service options
- D) Just Google security questions

**Explanation:** Know and use official resources: security portal, approved password manager, health checks, etc.
...
## Level 3 Assessment: Security Champions & Culture Leadership
...
**Explanation:** Champions advocate, educate, and help colleagues while connecting them with security resources.
...
**Scenario C:** Your team's phishing simulation results show a 15% click rate with only 20% of people reporting the suspicious email.
...
**Explanation:** Effective campaigns are brief, visual, and provide clear actions people can take.

---

**Q6. How should security culture survey results be used?**

- A) File them away and forget
- B) Identify improvement areas and measure progress over time ✓
- C) Punish teams with low scores
- D) Only share positive results

**Explanation:** Survey results guide improvement efforts and track culture progress over time.
...
### Practical Exercise: Security Awareness Campaign

**Exercise:** Design a security awareness campaign for the following scenario:

> **Situation:**
> - 500-person company
> - Recent phishing simulation showed 18% click rate
> - Only 15% of people reported the phishing email
> - Employee survey shows "security hinders productivity" perception
>
> **Goals:**
> - Reduce click rate to <8%
> - Increase report rate to >50%
> - Improve perception of security as helpful

**Deliverables:**

1. **Campaign Theme** - Engaging name and message
2. **Target Audiences** - Who needs what training
3. **Campaign Activities** - At least 5 activities over 3 months
4. **Communication Plan** - Channels and cadence
5. **Metrics** - How you'll measure success
6. **Security Champion Involvement** - How champions support

**Evaluation Criteria:**
- Activities are engaging, not fear-based
- Training addresses specific skill gaps (recognition, reporting)
- Communication is practical and accessible
- Metrics are measurable and aligned to goals
- Champions have clear, achievable role
